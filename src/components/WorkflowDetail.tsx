...
import { UI, STATUS_COLORS, WORKFLOW_COLOR, WORKFLOW_STATUS_COLORS } from "@/lib/colors";
  ...
  return (
    <div
      ...
      style={{
        ...
        border: `1px solid ${WORKFLOW_COLOR}44`,
        boxShadow: `0 0 30px ${WORKFLOW_COLOR}22, 0 4px 20px rgba(0,0,0,0.5)`,
        borderRight: "none",
        borderBottom: "none",
      }}
    >
      ...
      >
        <div className="flex items-center gap-2">
          <span style={{ color: WORKFLOW_COLOR, fontSize: 16 }}>⚙</span>
          <span className="font-mono font-bold text-sm" style={{ color: WORKFLOW_COLOR }}>
            {run.name}
          </span>
          <span
      ...
      <div className="overflow-y-auto custom-scrollbar flex-1 p-4 space-y-4">
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="text-center">
            ...
            <div className="text-lg font-mono font-bold" style={{ color: WORKFLOW_COLOR }}>{run.agentCount}</div>
          </div>
          ...
          {run.totalTokens !== undefined && (
            <div className="text-center">
              ...
              <div className="text-lg font-mono font-bold" style={{ color: WORKFLOW_COLOR }}>{formatNumber(run.totalTokens)}</div>
            </div>
          )}
                ...
                return (
                  <div key={phase.index}>
                    ...
                    <div
                      ...
                      style={{ background: `${WORKFLOW_COLOR}22` }}
                    >
                      <div
                        className="h-full rounded-full transition-all"
                        style={{ width: `${pct}%`, background: WORKFLOW_COLOR }}
                      />
                    </div>
                  </div>
                );
