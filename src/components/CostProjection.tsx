...
import type { AgentType, AgentState, AgentTypeBudgets } from "@/lib/types";
      ...
      {open && (
        ...
        >
          ...
          <PerTypeBudgets
            ...
            setAgentTypeBudget={setAgentTypeBudget}
          />
        </div>
      )}
...
/** Per-agent-type token budget inputs, shown only for types that currently
 *  have a non-terminal (running/waiting/idle) agent. */
function PerTypeBudgets({
  agents,
  agentTypeBudgets,
  setAgentTypeBudget,
}: {
